--*************************************************************************--
-- Title: Assignment07
-- Author: NasaaDuncombe
-- Desc: This file demonstrates how to use Functions
-- Change Log: When,Who,What
-- 2024-11-27,NasaaDuncombe,Created File
--**************************************************************************--
Begin Try
	Use Master;
	If Exists(Select Name From SysDatabases Where Name = 'Assignment07DB_NasaaDuncombe')
	 Begin 
	  Alter Database [Assignment07DB_NasaaDuncombe] set Single_user With Rollback Immediate;
	  Drop Database Assignment07DB_NasaaDuncombe;
	 End
	Create Database Assignment07DB_NasaaDuncombe;
End Try
Begin Catch
	Print Error_Number();
End Catch
go
Use Assignment07DB_NasaaDuncombe;
